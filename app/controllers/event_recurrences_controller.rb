class EventRecurrencesController < ApplicationController
  ...
  private
    ...
    def event_recurrence_params
      params.require(:event_recurrence).permit(:bill_id, :start_date, :end_date, :every, :interval, :first_name, :cell_phone, :email, :provider_name, :category_name, :contact_method)
    end
end
